...
# Connecting to DB
client = MongoClient(
    f"mongodb+srv://{MONGO_USER}:{MONGO_PASS}@cluster0.ewinp3v.mongodb.net/test", server_api=ServerApi('1'))
...
usr_name = Label(window, text=f"Connected to Cloud MongoDB as: Tushar Patil",
...
def view_tb():
    ...
    newWindow.configure(background="gray")  # Background color of window
    ...
    tree.grid(row=1, column=0, sticky='news', padx=20, pady=20)
